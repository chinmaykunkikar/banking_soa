...
public class mainEventClient {
	...
	public static void main(String[] args) {
		...
		Response resp = service.path("customer").path("executequery").request(MediaType.APPLICATION_JSON)
		...
		resp = service.request(MediaType.APPLICATION_JSON).post(Entity.json(inputJsonObj.toString()));
