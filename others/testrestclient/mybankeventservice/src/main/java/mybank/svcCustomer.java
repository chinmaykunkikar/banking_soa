...
public class svcCustomer {
	...
	public Response executequery(String data) {
		...
		try {
			 ...
			 * 
			 * //get the query and query type String query = (String) jo.get("query"); int
			 * querytype = ((Long)jo.get("querytype")).intValue();
			 * 
			 * jsonresult = db.executequery(query,querytype) ; //return json result from the
			 * query
			 * 
