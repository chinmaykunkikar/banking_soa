...
echo:
call mvn install:install-file -Dfile=%working_dir%\database\mysql-connector-java-8.0.18.jar -DgroupId=mysql -DartifactId=mysql-connector-java -Dversion=8.0.18 -Dpackaging=jar -DgeneratePom=true >> run_jevent.log 2>&1
echo - Done

echo:
echo - Installing json-simple-1.1.1.jar
echo:
call mvn install:install-file -Dfile=%working_dir%\database\json-simple-1.1.1.jar -DgroupId=com.googlecode.json-simple -DartifactId=json-simple -Dversion=1.1.1 -Dpackaging=jar -DgeneratePom=true >> run_jevent.log 2>&1
echo - Done
